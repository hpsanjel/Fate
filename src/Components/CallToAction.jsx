...
const CallToAction = () => {
	...
	return (
		<div className="container">
			<div className="flex flex-col md:flex-row py-2 justify-between md:p-2 md:mb-2">
				<div className="w-full mb-12 md:w-1/2 py-12">
					...
					<OutlinedButton type="submit" onClick={() => navigate(`/Destination`)} className="">
						Explore More
					</OutlinedButton>
				</div>

				<div className="img shrink-0">
					<img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dW5pdmVyc2l0eXxlbnwwfHwwfHx8MA%3D%3D" alt="admission open" className="w-full object-cover object-center rounded-full  md:mt-20" />
				</div>
			</div>
			<Stats />
		</div>
