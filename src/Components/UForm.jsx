...
import { UData } from "./UData" // Import your data
...
const UForm = () => {
	...
	const handleInputChange = (e) => {
		...
		const filteredData = UData.filter((uni) => uni.name.toLowerCase().includes(inputValue.toLowerCase()) || uni.location.toLowerCase().includes(inputValue.toLowerCase()) || uni.level.toLowerCase().includes(inputValue.toLowerCase()))
	...
	return (
		<div className="max-w-lg mx-auto mt-8">
			...
			<form>
				...
				{/* Location and Level inputs go here similarly */}
			</form>
