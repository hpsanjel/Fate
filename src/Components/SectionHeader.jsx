...
const SectionHeader = ({ first_heading }) => {
	return (
		<div>
			<div className="mt-24 flex flex-wrap">
				<div className="w-full px-4">
					<div className="mx-auto mb-[40px] max-w-[510px] text-center lg:mb-10">
						<span className="mb-2 block text-lg font-semibold text-primary">Header</span>

						<h2 className="mb-2 text-3xl font-bold sm:text-4xl md:text-[40px]">{first_heading} </h2>
