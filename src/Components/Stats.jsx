...
const Stats = () => {
	return (
		<div className="flex-col gap-2 mb-12 p-2 place-items-center md:flex-row grid grid-cols-1 md:grid-cols-3 bg-slate-50">
			<div className=" flex h-full p-4 place-items-center gap-4  bg-slate-50">
