...
const TeamMember = ({ name, role, photo, email, phone }) => {
	...
	return (
		<div className="relative flex flex-col items-center p-8 rounded-lg shadow-md bg-white" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
			<img className="w-24 h-24 rounded-full object-cover mx-auto mb-4" src={photo} alt={`${name} - Team Member`} />
