...
import InfoCard from "../../Includes/InfoCard";

export const Vision = () => {
	return (
		<div className="bg-white p-20">
			<div className="container grid grid-cols-1 gap-6 p-12 my-6 text-center md:text-left md:grid-cols-2 md:gap-12 lg:grid-cols-3 lg:gap-10 ">
