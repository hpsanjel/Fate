...
const LanguageclassNamees = () => {
	return (
		<>
			...
			<div className="overflow-x-scroll mb-12 p-6 md:p-0">
				<h1 className="text-3xl text-fatePrimary mb-4">Language Classes</h1>
				<table className="mx-auto w-full table-auto border-collapse mb-12 sm:mb-0 ">
					<thead>
						<tr className="rounded-lg text-md text-gray-700 text-left">
			...
			<div className="language-wrapper p-6 md-p-0">
				<div className="private mb-16">
					...
					<div className="grid gap-8 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 py-12">
						<div className="flex flex-col items-center gap-y-1 py-12 rounded-md hover:shadow-md  bg-fatePrimary/10 hover:text-fatePrimary/90">
				...
				<div className="private mb-16">
					...
					<div className="grid gap-4 grid-cols-1 items-center sm:grid-cols-2 p-12 bg-fatePrimary/10">
						...
						<div className="bg-white rounded-xl">
							<div className="text-center text-lg  mt-6">Who should attend our Japanese Classes</div>
							<div className="grid grid-cols-1 md:grid-cols-2 gap-8 m-4 p-4  justify-items-center place-items-center text-sm">
								<div className="bg-fatePrimary/10 w-full h-50  p-4 rounded-2xl"> Anyone planning to relocate to Japan and attend a Japanese course in order to prepare in advance for their assignment.</div>
								<div className="bg-fatePrimary/10 w-full h-50  p-4 rounded-2xl"> Those who are planning to go and work in Japan.</div>
								<div className="bg-fatePrimary/10 w-full h-50  p-4 rounded-2xl"> Government and non governmental agency representatives working in Japan who needs to be able to communicate at all levels.</div>
								<div className="bg-fatePrimary/10 w-full h-50  p-4 rounded-2xl"> Tourist guide professionals, hotel and restaurant workers.</div>
							</div>
						</div>
					</div>
				</div>

				<div className="flex flex-col md:flex-row bg-gray-200 py-8 mb-8 sm:mb-16">
					<div className="w-full md:w-1/2 px-20 py-4">
						<span className="text-3xl block  mb-4">Achievement through our course</span>
					...
					<div className="w-full md:w-1/2 px-20 py-4">
						<span className="text-3xl block mb-4">Class and its environment</span>
